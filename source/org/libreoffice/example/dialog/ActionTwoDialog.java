...
public class ActionTwoDialog implements XDialogEventHandler {
	
	private XDialog dialog;
	private static final String actionOk = "actionOk";
	private String[] supportedActions = new String[] { actionOk };
	
	public ActionTwoDialog(XComponentContext xContext) {
		this.dialog = DialogHelper.createDialog("ActionTwoDialog.xdl", xContext, this);
	}
